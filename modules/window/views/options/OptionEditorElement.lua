...
---@class MapPinEnhancedWindowOptionBodyElementMixin : Frame
...
MapPinEnhancedWindowOptionBodyElementMixin = {}


function MapPinEnhancedWindowOptionBodyElementMixin:ShowDescription()
    if self.option then
...
function MapPinEnhancedWindowOptionBodyElementMixin:OnLoad()
...
function MapPinEnhancedWindowOptionBodyElementMixin:UpdateInfoButtonVisibility()
...
function MapPinEnhancedWindowOptionBodyElementMixin:SetFormElement(formElement)
...
function MapPinEnhancedWindowOptionBodyElementMixin:Setup(optionData)
...
function MapPinEnhancedWindowOptionBodyElementMixin:Update()
