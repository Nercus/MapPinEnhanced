...
---@class MapPinEnhancedWindowSetImportFrameMixin : ScrollableTextarea
...
MapPinEnhancedWindowSetImportFrameMixin = {}

local L = MapPinEnhanced.L
local CONSTANTS = MapPinEnhanced.CONSTANTS


function MapPinEnhancedWindowSetImportFrameMixin:ShowExportFrame()
...
function MapPinEnhancedWindowSetImportFrameMixin:HideExportFrame()
...
function MapPinEnhancedWindowSetImportFrameMixin:ShowImportFrame()
...
function MapPinEnhancedWindowSetImportFrameMixin:HideImportFrame()
...
function MapPinEnhancedWindowSetImportFrameMixin:HideParent()
    self.mode = nil
    self:Hide()
    self.body.importExportFrameOpened = false
end

function MapPinEnhancedWindowSetImportFrameMixin:UpdateExportType(isCommand)
...
function MapPinEnhancedWindowSetImportFrameMixin:ImportCommands(commandString)
    local PinProvider = MapPinEnhanced:GetModule("PinProvider")
...
function MapPinEnhancedWindowSetImportFrameMixin:ImportString(importString)
    local PinProvider = MapPinEnhanced:GetModule("PinProvider")
...
function MapPinEnhancedWindowSetImportFrameMixin:ConfirmImport()
...
function MapPinEnhancedWindowSetImportFrameMixin:OnImportTextChanged()
    local text = self.editBox:GetText()
    if text == "" then
...
function MapPinEnhancedWindowSetImportFrameMixin:OnLoad()
