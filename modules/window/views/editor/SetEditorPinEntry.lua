...
---@class MapPinEnhancedWindowSetPinEntryMixin : Frame
...
MapPinEnhancedWindowSetPinEntryMixin = {}
...
---@param pin pinData
function MapPinEnhancedWindowSetPinEntryMixin:SetPin(pin)
    self.Pin:Setup(pin)
...
function MapPinEnhancedWindowSetPinEntryMixin:SetChangeCallback(callback)
    self.onChangeCallback = callback
end

---@param key changeableKeys
---@param value (string | number | boolean)?
function MapPinEnhancedWindowSetPinEntryMixin:OnChange(key, value)
...
function MapPinEnhancedWindowSetPinEntryMixin:SetupPinButton()
...
function MapPinEnhancedWindowSetPinEntryMixin:OnLoad()
...
function MapPinEnhancedWindowSetPinEntryMixin:OpenColorMenu()
    local pin = self.Pin
...
function MapPinEnhancedWindowSetPinEntryMixin:GenerateMenuTemplateFromMapData(parentTable, children, parent)
    if parent then
        ---@type table
...
function MapPinEnhancedWindowSetPinEntryMixin:GetMenuTemplate()
...
function MapPinEnhancedWindowSetPinEntryMixin:OpenMapHelperMenu()
