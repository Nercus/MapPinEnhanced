...
---@class MapPinEnhancedWindowSetExportFrameMixin : ScrollableTextarea
...
MapPinEnhancedWindowSetExportFrameMixin = {}

local L = MapPinEnhanced.L
local CONSTANTS = MapPinEnhanced.CONSTANTS


function MapPinEnhancedWindowSetExportFrameMixin:ShowExportFrame()
...
function MapPinEnhancedWindowSetExportFrameMixin:HideExportFrame()
...
function MapPinEnhancedWindowSetExportFrameMixin:ShowImportFrame()
...
function MapPinEnhancedWindowSetExportFrameMixin:HideImportFrame()
...
function MapPinEnhancedWindowSetExportFrameMixin:HideParent()
    self.mode = nil
    self:Hide()
    self.body.importExportFrameOpened = false
end

function MapPinEnhancedWindowSetExportFrameMixin:UpdateExportType(isCommand)
...
function MapPinEnhancedWindowSetExportFrameMixin:ImportCommands(commandString)
    local PinProvider = MapPinEnhanced:GetModule("PinProvider")
...
function MapPinEnhancedWindowSetExportFrameMixin:ImportString(importString)
    local PinProvider = MapPinEnhanced:GetModule("PinProvider")
...
function MapPinEnhancedWindowSetExportFrameMixin:ConfirmImport()
...
function MapPinEnhancedWindowSetExportFrameMixin:OnImportTextChanged()
    local text = self.editBox:GetText()
    if text == "" then
...
function MapPinEnhancedWindowSetExportFrameMixin:OnLoad()
