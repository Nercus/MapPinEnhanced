...
---@class MapPinEnhancedWindowSetBodyMixin : Frame
---@field activeEditorSet UUID | nil
---@field scrollFrame SetListScrollFrame
---@field sideBar MapPinEnhancedWindowSetSidebarMixin
---@field header MapPinEnhancedWindowSetBodyHeaderMixin
---@field pinListHeader Frame
---@field addPinButton Button
---@field importExportFrame MapPinEnhancedWindowSetImportExportFrameMixin
---@field createSetButton Button
---@field importButton Button
---@field importExportFrameOpened boolean?
MapPinEnhancedWindowSetBodyMixin = {}

local L = MapPinEnhanced.L


---@type FramePool<MapPinEnhancedWindowSetPinEntryMixin>
local PinEntryFramePool = CreateFramePool("Frame", nil, "MapPinEnhancedWindowSetPinEntryTemplate")
...
---@param value string
function MapPinEnhancedWindowSetBodyMixin:OnPinDataChange(set, setpinID, key, value)
    assert(set, "No set")
    if key == "delete" then
...
function MapPinEnhancedWindowSetBodyMixin:UpdatePinList()
    ...
    for _, pin in ipairs(pins) do
        local pinFrame = PinEntryFramePool:Acquire() --[[@as MapPinEnhancedWindowSetPinEntryMixin]]
...
function MapPinEnhancedWindowSetBodyMixin:OnLoad()
...
function MapPinEnhancedWindowSetBodyMixin:GetActiveSet()
    local SetManager = MapPinEnhanced:GetModule("SetManager")
    return SetManager:GetSetByID(self.activeEditorSet)
end

function MapPinEnhancedWindowSetBodyMixin:UpdateDisplayedElements()
...
function MapPinEnhancedWindowSetBodyMixin:SetActiveEditorSetID(setID)
...
---@return UUID | nil
function MapPinEnhancedWindowSetBodyMixin:GetActiveEditorSetID()
    return self.activeEditorSet
end

function MapPinEnhancedWindowSetBodyMixin:ExportSet(setID)
