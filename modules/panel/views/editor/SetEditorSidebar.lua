...
---@class MapPinEnhancedWindowSetSidebarMixin : Frame
...
---@field body MapPinEnhancedWindowSetBodyMixin
---@field header SetSidebarHeader
MapPinEnhancedWindowSetSidebarMixin = {}
...
function MapPinEnhancedWindowSetSidebarMixin:ToggleActiveSet(setID, override)
...
---@return AnyMenuEntry[]
function MapPinEnhancedWindowSetSidebarMixin:GetSetEntryMenuTemplate(setObject)
...
function MapPinEnhancedWindowSetSidebarMixin:UpdateSetList(sets)
    if not sets then
        local SetManager = MapPinEnhanced:GetModule("SetManager")
...
function MapPinEnhancedWindowSetSidebarMixin:GetFilteredSets(searchQuery)
...
function MapPinEnhancedWindowSetSidebarMixin:SetFirstSetActive()
...
function MapPinEnhancedWindowSetSidebarMixin:OnLoad()
...
---@param searchQuery string
function MapPinEnhancedWindowSetSidebarMixin:OnSearchChange(searchQuery)
    local filteredSets = self:GetFilteredSets(searchQuery)
    self:UpdateSetList(filteredSets)
end

function MapPinEnhancedWindowSetSidebarMixin:OnHide()
    MapPinEnhanced.UnregisterCallback(self, 'UpdateSetList')
end

function MapPinEnhancedWindowSetSidebarMixin:OnShow()
