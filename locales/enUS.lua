...
L["Wayfinder.General.Selection_LABEL"] = "Wayfinder"
L["Wayfinder.General.Selection_DESCRIPTION"] =
"Choose the single wayfinder used for navigation."
L["Arrow"] = "Arrow"
L["Floating"] = "Floating"
L["Wayfinder.Navigation_GROUPLABEL"] = "Navigation"
...
L["Wayfinder.Navigation.Minimap_DESCRIPTION"] = "Show the calculated route on the minimap."
L["Navigation Calculating"] = "Calculating a route..."
L["Navigation Direct Guidance"] = "No route is available. Follow the destination directly."
L["Navigation No Direction"] = "No direction is available for this destination."
L["Navigation Action Unavailable Combat"] = "This action will be available after combat."
L["Navigation Action Started"] = "Waiting for arrival confirmation."
L["Navigation Action Failed"] = "The action did not complete. Try again or recalculate the route."
L["Navigation Finding Another Route"] = "Finding another route..."
L["Navigation Arrival Confirming"] = "Confirming arrival..."
L["Navigation Approach"] = "Travel to %s."
L["Navigation Approach Method"] = "Go to the indicated travel point (%s)."
L["Navigation Continue To Method"] = "Continue to the next travel point (%s)."
L["Navigation Walk"] = "Travel to the next point."
L["Navigation Fly"] = "Fly to the next point."
L["Navigation Travel To Destination"] = "Travel to %s."
L["Navigation Fly To Destination"] = "Fly to %s."
L["Navigation Instruction Count"] = "%s (%d/%d)"
L["Navigation Route To"] = "Route to: %s (%s)"
L["Export Route to Chat"] = "Export Route to Chat"
L["Navigation Chat Unavailable"] = "Select an available chat channel or whisper before exporting the route."
L["Send"] = "Send"
L["Navigation Chat Choose Channel"] = "Choose where to send this route:"
L["Navigation Chat Whisper To"] = "Whisper to person"
L["Navigation Chat Player Name"] = "Player name or Name-Realm"
L["Navigation Chat Route Changed"] = "The route changed. Close this dialog and export it again."
L["Party"] = "Party"
L["Say"] = "Say"
L["Whisper"] = "Whisper"
L["Navigation Chat Use To"] = "Use %s to %s"
L["Navigation Chat Walk To"] = "Walk to %s"
L["Navigation Chat Fly To"] = "Fly to %s"
L["Navigation Chat Travel To"] = "Travel to %s"
L["Navigation Chat Change Floor To"] = "Change floor to %s"
L["Navigation Chat Talk To NPC"] = "Talk to NPC to reach %s"
L["Navigation Chat Change Phase To"] = "Change phase to %s"
L["Navigation Step Number"] = "Step %d: %s"
L["Navigation Use Portal"] = "Use the portal."
L["Navigation Use Portal To"] = "Use the portal to %s."
L["Navigation Cross Border"] = "Cross into the next area."
L["Navigation Change Floor"] = "Change to the indicated floor."
L["Navigation Talk To NPC"] = "Talk to the indicated NPC."
L["Navigation Take Transport"] = "Take the indicated transport."
L["Navigation Method Travel"] = "Travel"
L["Navigation Method Walking"] = "Walking"
L["Navigation Method Flying"] = "Flying"
L["Navigation Method Portal"] = "Portal"
L["Navigation Method NPC Travel"] = "NPC travel"
L["Navigation Method Border"] = "Border crossing"
L["Navigation Method Floor Change"] = "Floor change"
L["Navigation Method Spell"] = "Spell"
L["Navigation Method Item"] = "Item"
L["Navigation Method Toy"] = "Toy"
L["Navigation Method Boat"] = "Boat"
L["Navigation Method Dalaran Hearthstone"] = "Dalaran Hearthstone"
L["Navigation Method Flight Taxi"] = "Flight taxi"
L["Navigation Method Phase Change"] = "Phase change"
L["Navigation Method Ship"] = "Ship"
L["Navigation Method Tram"] = "Tram"
L["Navigation Method Transport"] = "Transport"
L["Navigation Method Teleport"] = "Teleport"
L["Navigation Method Zeppelin"] = "Zeppelin"
L["Navigation Use Spell"] = "Use the required spell."
L["Navigation Use Item"] = "Use the required item."
L["Navigation Use Toy"] = "Use the required toy."
L["Navigation Use Dalaran Hearthstone"] = "Use your Dalaran Hearthstone."
L["Navigation Use Teleport"] = "Use the indicated teleport."
L["Recalculate Route"] = "Recalculate Route"
L["%s - %s"] = "%s - %s"
...
L["Navigation Transportation NPC travel"] = "NPC travel"
L["Navigation Transportation Phase changes"] = "Phase changes"
L["Navigation Transportation Personal teleports"] = "Personal teleports"
L["Navigation Transportation Dungeon teleports"] = "Dungeon teleports"

L["Wayfinder.Display_GROUPLABEL"] = "Display"
L["Settings for Floating; Arrow is still selected."] = "Settings for Floating; Arrow is still selected."
