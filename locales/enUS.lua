...
L["Save"] = "Save"
L["Delete"] = "Delete"
L["Collection Title"] = "Collection Title"
L["Select a collection to edit."] = "Select a collection to edit."
L["A collection named \"%s\" already exists."] = "A collection named \"%s\" already exists."
