...
local versionMPH = C_AddOns.GetAddOnMetadata("MapPinEnhanced", "Version")
...
local function detectPinData()
  ...
  if GetMouseFocus then
    resultTable = GetMouseFocus()
  else
    resultTable = GetMouseFoci()
    resultTable = resultTable and resultTable[1]
  end
