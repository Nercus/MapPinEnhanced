...
---@field OnUnused? fun(registry: CallbackHandlerRegistry, target: table, eventName: MapPinEnhancedEvent) If defined, called when an event stops.
---@field OnUsed? fun(registry: CallbackHandlerRegistry, target: table, eventName: MapPinEnhancedEvent) If defined, called when an event starts.
