...
---@field RegisterCallback fun(self: MapPinEnhanced, event: "PIN_REMOVED", func: fun(eventname: string, group: MapPinEnhancedGroupMixin, pinID: UUID))
...
---@field RegisterCallback fun(self: MapPinEnhanced, event: "SUPER_TRACKING_ENTRY_CHANGED", func: fun(eventname: string))
MapPinEnhanced = {}
...
---@field FireCallback fun(self: MapPinEnhanced, event: "PIN_REMOVED", key: nil, group: MapPinEnhancedGroupMixin, pinID: UUID)
...
---@field FireCallback fun(self: MapPinEnhanced, event: "SUPER_TRACKING_ENTRY_CHANGED")
MapPinEnhanced = {}
...
---@field UnregisterCallback fun(self: MapPinEnhanced, event: "PIN_UPDATED_DESCRIPTION", func: fun(eventname: string, description: string?), key: string)
